...
ToggleListButton.Position = UDim2.new(0, 10, 0, 120) -- Przesunięcie w dół o 110 jednostek
...
-- Ramki i odstępy 
ScrollingFrame.Position = UDim2.new(0, 10, 0 ,113) -- Przesunięcie w dół o jednostkę
ScrollingFrame.Size=UDim2.new(0 ,200 ,0 ,240)
